...
if uploaded_file is not None and job_description:
    ...
    required_experience = st.number_input("Enter required years of experience", min_value=0, value=3)
    candidate_experience = st.number_input("Enter your years of experience", min_value=0, max_value=20, value=5)
